        ...
        <div className="flex flex-col sm:flex-row gap-4 p-4">
          ...
          <main className="flex-1 flex flex-col items-center">
            <div className="w-full flex justify-between items-center mb-6">
              <h2 className="text-xl font-semibold text-gray-800">MIS HOTELES FAVORITOS</h2>
            ...
            <div className="flex flex-wrap gap-6 justify-center w-full">
              {!loading && !error && flatsFiltrados.length === 0 && (
                <div className="text-gray-500 text-center py-8">
                  ...
                  <p>No se encontraron hoteles favoritos que coincidan con los filtros seleccionados.</p>
                </div>
              )}
              {flatsFiltrados.map((flat, idx) => (
                <HotelCard key={idx} {...flat} isInitiallyFavorited={true} />
              ))}
            </div>
          </main>
        </div>
